...
&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <asp:DropDownList ID="hostel" runat="server" Font-Bold="True" Font-Size="X-Large" DataSourceID="SqlDataSource1" DataTextField="h_name" DataValueField="h_id">
        </asp:DropDownList>
        <br />
        <asp:DropDownList ID="room" runat="server" DataSourceID="SqlDataSource2" DataTextField="r_id" DataValueField="r_id"></asp:DropDownList>
