    ...
    protected void register_Click(object sender, EventArgs e)
    {
       ...
       // string sid, hid, r_id, s_name, dob1, college1,contact_no1,parents_c_no1, joining_date1;
        ...
        //string hostel;
          ...
          //  cn.Open();
        string h = "insert into student(h_id,r_id,s_name,password,dob,college,contact_no,parents_c_no,joining_date) values('" + hostel.Text + "','" + room.Text + "','" + username.Text + "','" + passwd.Text + "','" + dob.Text + "','" + college.Text + "','" + contact_no.Text + "','" + parentsno.Text + "','" + joindate.Text + "')";
